...
Prompt GPT-5.4 for long-running tasks, tool use, and reliable execution.
...
When troubleshooting cases where GPT-5.4 treats an intermediate update as the final answer, verify your integration preserves the assistant message `phase` field correctly. See [Phase parameter](#phase-parameter) for details.
